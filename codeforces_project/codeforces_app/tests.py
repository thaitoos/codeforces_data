...
class Tests(TestCase):
    ...
    def test_get_contestant_place(self):
        ...
        cont.save()
        cont = Contestant(rating = 2900, handle = "b", index = 2)
        cont.save()
        cont = Contestant(rating = 2900, handle = "c", index = 3)
        cont.save()
        cont = Contestant(rating = 1000, handle = "d", index = 4)
        cont.save()
        cont = Contestant(rating = 900, handle = "e", index = 5)
        cont.save()
        cont = Contestant(rating = -10, handle = "f", index = 6)
        cont.save()
